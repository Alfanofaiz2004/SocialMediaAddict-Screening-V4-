...
export default function KuesionerPage() {
  ...
  useEffect(() => {
    ...
    if (!storedName) {
      window.dispatchEvent(new Event('open-screening-modal'));
      return;
    }
    ...
    window.addEventListener('name-submitted', handleNameSubmitted);
    return () => window.removeEventListener('name-submitted', handleNameSubmitted);
  }, [router]);
