      ...
      <main className="flex-grow w-full flex flex-col items-center pb-24">
        ...
        <article className="w-full max-w-7xl px-6 md:px-12 mt-12 md:mt-16 mx-auto">
          ...
          <header className="mb-14 border-b border-outline-variant pb-10">
            <div className="flex items-center gap-3 text-primary text-sm md:text-base font-bold uppercase tracking-wider mb-6">
              <span className="material-symbols-outlined text-[20px]">menu_book</span>
              Deep Dive & Edukasi
            </div>
            <h1 className="text-4xl md:text-5xl font-extrabold text-on-surface leading-tight mb-8 text-left">
              Membedah SVAS-6: Landasan Ilmiah di Balik Kecanduan Video Pendek
            </h1>
            <div className="flex flex-wrap items-center gap-4 text-on-surface-variant text-base md:text-lg font-medium">
          ...
          <div className="text-lg md:text-xl font-medium text-on-surface leading-relaxed text-justify w-full">
            ...
            <p className="mb-6">
              Tes yang kamu kerjain di website ini tuh bukan kuis tebak-tebakan abal-abal, lho. Kami menggunakan instrumen psikometrik asli bernama <strong className="font-bold">Short Video Addiction Scale (SVAS)</strong>. Skala ini awalnya dikembangkan dan divalidasi oleh para peneliti di China (Ye et al., 2024) di bidang psikologi dan perilaku digital, sebagai respons terhadap betapa gilanya fenomena kecanduan platform video pendek secara global.
            </p>
            <p className="mb-6">
              Secara ilmiah, SVAS dirancang berdasarkan konsep <em className="italic">behavioral addiction</em> (kecanduan perilaku). Instrumen ini awalnya diadaptasi dari <em className="italic">Bergen Facebook Addiction Scale (BFAS)</em>, yang kemudian dioptimalkan lagi menjadi versi super ringkas yang disebut <strong className="font-bold">SVAS-6 items</strong>. Dengan cuma enam butir pernyataan, alat ini udah bisa mengidentifikasi kecenderungan perilaku adiktif seseorang dengan sangat presisi.
            </p>
            <p className="mb-10">
              Biar kamu makin yakin, instrumen ini punya performa psikometrik yang "sakti" banget di dunia akademik! Pengujian konsistensi internalnya menunjukkan nilai koefisien <em className="italic">Cronbach's alpha</em> sebesar 0,799 dan <em className="italic">McDonald's omega</em> 0,808. Stabilitas metrik skala ini juga diperkuat oleh nilai <em className="italic">intraclass correlation coefficient (ICC)</em> sebesar 0,994 serta rentang <em className="italic">Cohen's kappa</em> antara 0,667 hingga 0,913. Ditambah lagi, lewat analisis faktor konfirmatori, SVAS-6 terbukti sebagai instrumen satu faktor yang sangat ringkas dan efisien (Katsiroumpa et al., 2025).
            </p>
            ...
            <h3 className="text-2xl md:text-3xl font-bold text-on-surface mt-14 mb-6 flex items-center gap-4 text-left">
              <span className="material-symbols-outlined text-primary text-[36px] md:text-[40px]">psychology</span>
            ...
            <p className="mb-6 italic text-on-surface-variant/90">
            ...
            <div className="bg-surface-variant/30 rounded-2xl p-6 md:p-8 space-y-6 text-base md:text-lg font-normal border border-outline-variant mb-12">
              <div>
                <strong className="text-primary block mb-2 font-bold">Contoh perilaku:</strong>
              ...
              <div>
                <strong className="text-error block mb-2 font-bold">Dampak:</strong>
                <ul className="list-disc pl-6 space-y-2">
              ...
              <div>
                <strong className="text-secondary block mb-2 font-bold">Cara mengatasinya:</strong>
                <ul className="list-disc pl-6 space-y-2">
            ...
            <h3 className="text-2xl md:text-3xl font-bold text-on-surface mt-14 mb-6 flex items-center gap-4 text-left">
              <span className="material-symbols-outlined text-primary text-[36px] md:text-[40px]">mood</span>
            ...
            <h3 className="text-2xl md:text-3xl font-bold text-on-surface mt-14 mb-6 flex items-center gap-4 text-left">
              <span className="material-symbols-outlined text-primary text-[36px] md:text-[40px]">update</span>
            ...
            <h3 className="text-2xl md:text-3xl font-bold text-on-surface mt-14 mb-6 flex items-center gap-4 text-left">
              <span className="material-symbols-outlined text-primary text-[36px] md:text-[40px]">sick</span>
            ...
            <h3 className="text-2xl md:text-3xl font-bold text-on-surface mt-14 mb-6 flex items-center gap-4 text-left">
              <span className="material-symbols-outlined text-primary text-[36px] md:text-[40px]">gavel</span>
            ...
            <h3 className="text-2xl md:text-3xl font-bold text-on-surface mt-14 mb-6 flex items-center gap-4 text-left">
              <span className="material-symbols-outlined text-primary text-[36px] md:text-[40px]">sync_problem</span>
            ...
            <p className="mb-6">
              Dalam penelitian aslinya, skala SVAS-6 menetapkan nilai ambang batas (<em className="italic">cut-off point</em>) optimal sebesar 15. Artinya, kalau skor totalmu <strong className="font-bold">≥ 15</strong>, itu mengindikasikan kecenderungan penggunaan video pendek yang problematis dengan probabilitas kecanduan tinggi. Sebaliknya, kalau skormu <strong className="font-bold">&lt; 15</strong>, kamu dikategorikan sebagai pengguna yang sehat (Katsiroumpa et al., 2025). 
            </p>
            <p className="mb-8">
            ...
            <ul className="list-disc pl-8 space-y-4 mb-12 text-lg md:text-xl font-medium marker:text-primary">
              <li>
                <strong className="font-bold">Sebagai Sarana Skrining (Deteksi Dini):</strong> Mengidentifikasi individu yang berisiko mengalami gangguan perilaku akibat penggunaan video pendek yang berlebihan sebelum jadi makin parah.
              </li>
              <li>
                <strong className="font-bold">Sebagai Instrumen Pemetaan Perilaku:</strong> Membantu kita memahami dimensi kecanduan mana yang paling dominan. Misalnya, apakah kamu paling bermasalah di hilangnya kontrol (Relapse) atau malah di gangguan tanggung jawab (Conflict)?
              </li>
              <li>
                <strong className="font-bold">Sebagai Alat Evaluasi Intervensi:</strong> Dipakai untuk menilai efektivitas tindakan pencegahan. Coba tes lagi bulan depan setelah kamu ngurangin jatah main HP, dan lihat apakah skor SVAS-mu membaik!
              </li>
            </ul>
            ...
            <p className="mb-10">
              Mungkin kamu bingung, "Tes kecanduan kok nanyain jam tidur sama gangguan produktivitas?" <em className="italic">Well</em>, kecanduan medsos itu nggak pernah menyerang sendirian. Dia bakal ngerusak pilar utama kesehatanmu melalui dua jalur ini:
            </p>
            
            <h3 className="text-2xl md:text-3xl font-bold text-on-surface mt-14 mb-6 flex items-center gap-4 text-left">
              <span className="material-symbols-outlined text-primary text-[36px] md:text-[40px]">brightness_4</span>
              1. Manipulasi Sirkadian (Efek Blue Light)
            </h3>
            <p className="mb-12">
              Layar HP memancarkan cahaya biru (<em className="italic">blue light</em>) yang menipu kelenjar di otakmu buat mikir "Oh, masih siang nih." Akibatnya, produksi melatonin (hormon tidur) mandek. Efeknya? Kamu jadi susah tidur, kualitas tidur memburuk, dan siklus sirkadianmu berantakan.
            </p>

            <h3 className="text-2xl md:text-3xl font-bold text-on-surface mt-14 mb-6 flex items-center gap-4 text-left">
              <span className="material-symbols-outlined text-primary text-[36px] md:text-[40px]">battery_alert</span>
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-on-surface mt-16 mb-8 text-left">
              <em className="italic">So, What's Next?</em>
            </h2>
            <p className="mb-10">
          ...
          <div className="mt-20 pt-12 border-t border-outline-variant flex justify-center">
            <Link
              ...
              className="inline-flex items-center gap-4 bg-primary text-on-primary px-12 py-6 rounded-2xl font-extrabold text-xl md:text-2xl hover:bg-primary/90 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
